...
private extension AppDelegate {
    func makeDependencies() -> AppDependency {
        ...
        let uiConfig = PumpkinPieChat<PumpkinPieModels>.UIConfiguration(
            fonts: AppStyleConfig.fonts,
            colors: AppStyleConfig.colors,
            strings: PumpkinPieChat<PumpkinPieModels>.UIConfiguration.Strings(
        ...
        let networkConfig = PumpkinPieChat<PumpkinPieModels>.NetworkConfiguration(configUrl: configUrl)
        let chat = PumpkinPieChat<PumpkinPieModels>(networkConfig: networkConfig, uiConfig: uiConfig)
