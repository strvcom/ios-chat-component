...
public struct ConversationFirestore: ConversationRepresenting, Decodable {
    ...
    public init(id: EntityIdentifier, lastMessage: MessageFirestore?, members: [UserFirestore], messages: [MessageFirestore], seen: Seen, memberIds: [EntityIdentifier]) {
        self.id = id
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.memberIds = try values.decode([EntityIdentifier].self, forKey: .members)
    ...
    public mutating func setSeenMessages(_ seen: (messageId: EntityIdentifier, seenAt: Date), currentUserId: EntityIdentifier) {
